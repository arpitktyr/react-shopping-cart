...
const Carousel=()=>{
  ...
  {filterProduct.map((products) => (
    <div className="slider-item" key={products.id}>
      <Link className="product-title carousel-title" data={products.id} to={`/product/${products.id}`}>
        <img  className="slider-img" src={products.image} alt={products.title} /> </Link>
        ...
        <div className="rating-review">
          <span  className="rating">
            <div className="rating-no">{products.rating.rate}
            <img src="data:image/svg+xml;base64," className="review-icon" alt="star" />
            </div>
          </span>
