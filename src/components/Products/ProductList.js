          ...
          <ul className="list-group subcategory">
            ...
            <li className="list-group-item">
              ...
              <span className="sort-by-item" >
                <input type="radio" id="lth" name="sortOption" value="price_low_to_high"
               checked={sortOption === "price_low_to_high"}
               onChange={handleSortOptionChange}  /><label htmlFor="lth"> Price low to high </label></span>
            <span className="sort-by-item" >
              <input
               type="radio" id="htl" name="sortOption" value="price_high_to_low"
               checked={sortOption === "price_high_to_low"}
               onChange={handleSortOptionChange} 
               />
               <label htmlFor="htl"> Price high to low </label></span></li>
           </ul>
        </div>
